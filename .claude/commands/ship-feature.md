...
Good: "feat: add org-scoped lead scoring for industrial fit"
Bad: "feat: added POST route to leads router"
...
Example: "Add company enrichment lookup with caching"
...
## How to test
1. Run `docker compose up` (or `apps/api` + `apps/web` dev servers per README)
2. Log in as a seeded demo org user (see /seed-user)
