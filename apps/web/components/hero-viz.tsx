...
export function HeroViz() {
  return (
    <div className="mt-16 flex items-center justify-start gap-4">
      {/* Card */}
      <div className="w-36 h-20 border border-black/15 bg-white flex flex-col items-start justify-center px-4 gap-1.5 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
      ...
      <div className="flex items-center gap-1">
        ...
        <ArrowRight size={12} className="text-[#E65527]" />
      </div>
      {/* Table */}
      <div className="w-36 h-20 border border-black/15 bg-white flex flex-col justify-center px-3 gap-1">
      ...
      {/* Score */}
      <div className="w-36 h-20 border-2 border-[#E65527] bg-white flex flex-col items-center justify-center gap-0.5">
